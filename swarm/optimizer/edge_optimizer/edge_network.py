...
class EdgeNetwork(nn.Module):
    def __init__(self, llm_backbone_name, num_edges, init_probability=0.5):
        ...
        bias = torch.full((num_edges,), torch.log(torch.tensor(init_probability / (1 - init_probability))))
        with torch.no_grad:
